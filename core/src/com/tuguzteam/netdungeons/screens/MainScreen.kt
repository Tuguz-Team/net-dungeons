...
class MainScreen(loader: Loader) : StageScreen(loader) {
    ...
    private val navGameButton =
        ImageTextButton("Game", ImageTextButtonStyle(null, null, null, BitmapFont()))
    private val navProfileButton =
        ImageTextButton("Profile", ImageTextButtonStyle(null, null, null, BitmapFont()))
